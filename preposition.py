...
print(f"prop15 (Commutative OR): {prop15.subs({p: p_value, q: q_value})}")
print(f"prop16 (Commutative AND): {prop16.subs({p: p_value, q: q_value})}")
print(f"prop17 (Associative OR): {prop17.subs({p: p_value, q: q_value, r: p_value})}")
print(f"prop18 (Associative AND): {prop18.subs({p: p_value, q: q_value, r: p_value})}")
